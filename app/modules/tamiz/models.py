...
class TamizEnsayo(Base):
    """Registro historico de reportes Tamiz ASTM C117-23."""

    __tablename__ = "tamiz_ensayos"
    ...
    porcentaje_material_fino_pct = Column(Float, nullable=True)
