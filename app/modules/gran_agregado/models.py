...
class GranAgregadoEnsayo(Base):
    """Registro histórico de reportes Granulometría de Agregados."""

    __tablename__ = "gran_agregado_ensayos"
    ...
    error_tamizado_pct = Column(Float, nullable=True)
