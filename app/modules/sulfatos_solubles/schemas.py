...
"""
Pydantic schemas for Sulfatos Solubles.
"""
...
class SulfatosSolublesRequest(BaseModel):
    """Payload para generar reporte Sulfatos Solubles."""
...
class SulfatosSolublesEnsayoResponse(BaseModel):
    """Salida para historial Sulfatos Solubles."""
...
class SulfatosSolublesDetalleResponse(SulfatosSolublesEnsayoResponse):
    """Detalle completo para edicion/visualizacion."""

    payload: Optional[SulfatosSolublesRequest] = None


class SulfatosSolublesSaveResponse(BaseModel):
