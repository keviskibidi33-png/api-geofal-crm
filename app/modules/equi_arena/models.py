...
class EquiArenaEnsayo(Base):
    """Registro histórico de reportes Equivalente de Arena."""

    __tablename__ = "equi_arena_ensayos"
    ...
    equivalente_arena_promedio_pct = Column(Float, nullable=True)
