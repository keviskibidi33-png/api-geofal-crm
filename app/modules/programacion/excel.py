...
def _resolve_admin_header_field(normalized_header: str) -> tuple[str, bool] | None:
    ...
    direct_map: dict[str, tuple[str, bool]] = {
        ...
        "VALORIZACION": ("numero_valorizacion", False),
        "N VALORIZACION": ("numero_valorizacion", False),
        "NRO VALORIZACION": ("numero_valorizacion", False),
...
def _discover_admin_template_mapping(
    ...
    fallback_map: dict[str, tuple[str, bool]] = {
        ...
        "I": ("orden_servicio", False),
        "J": ("numero_valorizacion", False),
        "K": ("numero_factura", False),
        "L": ("estado_pago", False),
        "M": ("estado_autorizar", False),
        "N": ("nota_admin", False),
    }
