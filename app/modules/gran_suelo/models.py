...
class GranSueloEnsayo(Base):
    """Registro histórico de reportes Granulometría de Suelos."""

    __tablename__ = "gran_suelo_ensayos"
    ...
    perdida_cpl_pct = Column(Float, nullable=True)
