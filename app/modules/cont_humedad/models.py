...
class ContHumedadEnsayo(Base):
    """Registro historico de reportes Contenido de Humedad (ASTM C566-25)."""

    __tablename__ = "cont_humedad_ensayos"
    ...
    contenido_humedad_pct = Column(Float, nullable=True)
