...
class AbrassEnsayo(Base):
    """Registro historico de reportes ABRASS (ASTM C131/C131M-20)."""

    __tablename__ = "abrass_ensayos"
    ...
    perdida_abrasion_promedio_pct = Column(Float, nullable=True)
