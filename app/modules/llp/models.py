...
class LLPEnsayo(Base):
    """Registro histórico de reportes LLP generados."""

    __tablename__ = "llp_ensayos"
    ...
    limite_liquido_promedio = Column(Float, nullable=True)
    limite_plastico_promedio = Column(Float, nullable=True)
    indice_plasticidad = Column(Float, nullable=True)
