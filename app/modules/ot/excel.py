...
TEMPLATE_FILENAME = "OT/OT-001-Geofal.xlsx"
SHEET_NAME = "CENS"
TEMPLATE_CONCRETO_FILENAME = "OT/OT-CONCRETO/OT-CONCRETO-Geofal.xlsx"
SHEET_CONCRETO_NAME = "MYP"
TEMPLATE_SU_AG_FILENAME = "OT/OT-MUESTRAS/OT-MUESTRAS-Geofal.xlsx"
...
def generar_excel_ot_concreto(ot: OrdenTrabajo) -> io.BytesIO:
    ...
    def _transform(sheet_xml: bytes) -> bytes:
        ...
        set_cell(sheet_data, f"C{responsables_row}", ot.ot_aperturada_por or "BETZABETH SARAVIA", merge_anchor_map=merge_map)
