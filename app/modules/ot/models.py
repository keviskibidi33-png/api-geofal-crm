...
class OrdenTrabajo(Base):
    ...
    referencia = Column(Text, nullable=True, default="-")
    ...
    ot_aperturada_por = Column(Text, nullable=True)
    ot_designada_a = Column(Text, nullable=True)
    ...
    actualizado_por = Column(Text, nullable=True)
