...
def _fill_sheet(sheet_xml: bytes, payload: ImpOrganicasRequest) -> bytes:
    ...
    set_cell(sheet_data, "H17", payload.tamano_particula or "", merge_anchor_map=merge_anchor_map, style_ref="H17")
    set_cell(sheet_data, "H18", payload.fecha_inicio_ensayo or "", merge_anchor_map=merge_anchor_map, style_ref="H18")
    set_cell(sheet_data, "H19", payload.fecha_fin_ensayo or "", merge_anchor_map=merge_anchor_map, style_ref="H19")
    set_cell(sheet_data, "H20", payload.temperatura_solucion_c, is_number=True, merge_anchor_map=merge_anchor_map, style_ref="H20")
