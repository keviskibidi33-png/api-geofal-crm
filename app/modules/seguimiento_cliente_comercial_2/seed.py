...
from app.modules.seguimiento_cliente_comercial_2.service import SeguimientoClienteComercialService
...
def main():
    ...
    try:
        ...
        print("Tabla 'seguimiento_cliente_comercial_2' verificada/creada con éxito.")
    ...
    template_path = os.path.abspath(
        os.path.join(
            ...
            "..",
            "templates",
            "template_Seguimiento cliente 2.xlsx"
        )
    )
    ...
    try:
        ...
        print(f"¡Éxito! Se importaron {count} registros a la tabla 'seguimiento_cliente_comercial_2'.")
    except Exception as e:
        db.rollback()
